...
var createSlick = () => {
    $('[data-slickslider]').each(function (i) {
        var webSlider = $(this).data('slick-desktop-init'),
            tabSlider = $(this).data('slick-tab-init'),
            mobileSlider = $(this).data('slick-mobile-init');
        // Web settings
        var genSettings = {
            ...
            fade: ($(this).data('slick-fade') === true) ? true : false
        }
        // console.log('fadeEffect: '+$(this).data('slick-fade'));
        // console.log(genSettings);
        if (webSlider !== undefined) {
            if (webSlider == true) {
                var webSettings = {
                    autoplay: $(this).data('slick-autoplay'),
                    autoplaySpeed: $(this).data('slick-autoplayspeed'),
                    ...
                    slidesToScroll: $(this).data('slick-desktop-show'),
...
["shopify:section:load", "shopify:section:select"].forEach(function(ev){
